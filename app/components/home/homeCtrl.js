...
(function () {
    ...
    function homeCtrl($scope, $http, $timeout, $location, $anchorScroll, $interval, $rootScope) {
      ...
      $scope.roles = [
        {selected: false, name: "Werwolf", description: "Während der ersten Nacht lernen die Werwölfe die Identität der anderen Werwölfe kennen. In jeder folgenden Nacht müssen sich die Werwölfe gemeinsam auf ein Opfer einigen, das daraufhin getötet wird. Wenn sich die Werwölfe binnen einer Minute nicht auf ein Opfer einigen können, dürfen sie in dieser Nacht keinen Spieler töten. Die Werwölfe dürfen während der Nacht keinen anderen Werwolf als Opfer auswählen. Werwölfe versuchen während des Tages ihren wahren Charakter zu verheimlichen."},
        {selected: false, name: "Dorfbewohner", description: "Der Dorfbewohner hat keine besonderen Fähigkeiten."},
        {selected: false, name: "Hexe", description: "Die Hexe erwacht immer direkt nachdem die Werwölfe ihr Opfer ausgesucht haben. Sie hat im Verlauf des gesamten Spiels einen Gift- und einen Heiltrank. Der Spielleiter zeigt auf die Person, die von den Werwölfen als Mordopfer gewählt wurde und die Hexe kann diese mit ihrem Heiltrank heilen (auch sich selbst), so dass es am nächsten Morgen keinen Toten gibt. Sie kann aber auch den Gifttrank auf einen anderen Spieler anwenden; dann gibt es mehrere Tote."},
        {selected: false, name: "Seherin", description: "Die Seherin erwacht, während alle anderen schlafen und darf sich eine Person aussuchen, deren Rolle ihr der Spielleiter offenbaren soll. Dabei sollte der Spielleiter möglichst unauffällig vorgehen, idealerweise wiederum durch Gesten, so dass die Schlafenden nicht hören und raten können, welche Person erwählt wurde. Da die Seherin zu jeder Runde die Rolle einer weiteren Person im Spiel kennt, kann sie großen Einfluss nehmen, muss aber ihr Wissen vorsichtig einsetzen."},
        {selected: false, name: "Armor", description: "Amor erwacht nur einmal in der allerersten Nacht, um zwei Spieler seiner Wahl miteinander zu verkuppeln (eventuell auch sich selbst). Danach schläft er wieder ein. Anschließend berührt der Spielleiter die beiden Verliebten an der Schulter, sodass diese kurz erwachen können und wissen, wer der jeweilige Partner ist. Die Verliebten haben im Laufe des Spiels die Aufgabe, den Partner zu beschützen, denn wenn einer der beiden stirbt, macht es ihm der Partner trauernd nach; sie dürfen nie gegeneinander stimmen."},
        {selected: false, name: "Jäger", description: "Scheidet der Jäger aus dem Spiel aus, feuert er in seinem letzten Atemzug noch einen Schuss ab, mit dem er einen Spieler seiner Wahl mit in den Tod reißt, d.h. er bestimmt einen Spieler, der mit ihm aus dem Spiel ausscheidet."},
        {selected: false, name: "Dieb", description: "Der Dieb ist der erste, der im Spiel erwacht. Wird mit Dieb gespielt, werden zwei Karten mehr ausgeteilt. Der Dieb darf diese ansehen und seine Karte gegen eine der beiden übrig gebliebenen Karten austauschen. Er hat ab jetzt also eine neue Rolle. Möchte er nicht tauschen, ist er für den Rest des Spiels einfacher Dorfbewohner. (Bleiben am Ende zwei Werwölfe übrig, muss der Dieb seine Karte tauschen, da die Werwölfe sonst im Spiel keine realistische Chance hätten.)"},
        {selected: false, name: "Mädchen", description: "Das kleine Mädchen darf nachts in der Werwolf-Phase heimlich blinzeln, um so die Werwölfe zu erkennen. Die Werwölfe ihrerseits hingegen achten natürlich darauf, das Mädchen dabei zu ertappen, es besteht also beim Blinzeln ein gewisses Risiko."},
        {selected: false, name: "Heiler", description: "Der Heiler erwacht am Anfang jeder Nacht und bestimmt einen Spieler (auch sich selbst), den er vor den Werwölfen beschützen will. Selbst wenn der ausgewählte Spieler von den Werwölfen gebissen wird, stirbt er nicht. Es ist nicht erlaubt, zwei Runden hintereinander denselben Charakter zu schützen, da dieser sonst unsterblich wäre."},
        {selected: false, name: "Sündenbock", description: "Immer wenn es im Dorf zu einer Pattsituation während der Abstimmung kommt, trifft es sofort den Sündenbock. Allerdings bleibt ihm ein Vorrecht: Er darf entscheiden, wer am nächsten Tag abstimmen darf."},
        {selected: false, name: "Dorfdepp", description: "Wird der Dorfdepp vom Dorfgericht als Opfer auserkoren, erkennen sie im letzten Moment, dass es sich nur um den Dorfdepp handelt. Der Dorfdepp darf weiter leben, hat aber nun kein Abstimmungsrecht mehr."},
        {selected: false, name: "Der Alte", description: "Der Alte überlebt den ersten Angriff der Werwölfe. Wird er aber vom Dorfgericht zum Opfer bestimmt, durch die Hexe oder den Jäger umgebracht, verliert das Dorf seine Weisheit und alle Sonderrollen werden zu einfachen Dorfbewohnern. Außerdem vergisst das Dorf, dass sie den Dorfdepp verschonen wollten."},
        {selected: false, name: "Flötenspieler", description: "Der Flötenspieler ist eine eigene Partei und kann nur alleine das Spiel gewinnen, außer er ist verliebt. Er erwacht immer am Ende jeder Nacht und bestimmt zwei Spieler, die er mit seiner Musik verzaubert. Anschließend schläft er ein und alle verzauberten Spieler erwachen, erkennen sich und schlafen ebenfalls wieder ein. Der Flötenspieler gewinnt das Spiel alleine, wenn alle anderen Spieler verzaubert sind."},
        {selected: false, name: "Die reine Seele", description: "Die reine Seele ist die einzig offen gespielte Identität, deren Rollekarte auf beiden Seiten das Bild eines normalen Dorfbewohner zeigt. Die Person mit dieser Rolle hat zwar dementsprechend keine Sonderfähigkeiten, verkörpert aber dafür einen eindeutig verifizierten Guten und ist damit eine sichere Option bei der Wahl des Hauptmannes oder Büttels."},
        {selected: false, name: "Der Engel", description: "Wenn er in der Abstimmung der ersten Runde eliminiert wird (nicht von den Werwölfen), gewinnt er das Spiel allein."},
        {selected: false, name: "Der Fuchs", description: "Wenn er in der Nacht aufgerufen wird, wählt er einen Spieler aus und erfährt vom Spielleiter, ob dieser oder einer seiner beiden Nachbarn ein Werwolf ist oder nicht. Ist bei dem Trio mindestens ein Werwolf dabei, darf er es in der nächsten Nacht ein weiteres Mal versuchen. Ist aber keiner der drei ein Werwolf, verliert er seine Fähigkeit."},
        {selected: false, name: "Aura-Seherin", description: "Die Aura-Seherin sucht nach Spielern mit speziellen Fähigkeiten, die nicht nur einfache Dorfbewohner oder Werwölfe sind. Der Moderator sollte vor Spielbeginn festlegen, was spezielle Fähigkeiten sind. Beim nächtlichen Aufruf der Aura-Seherin deutet diese auf einen der Mitspieler und erhält von Moderator den „Daumen hoch“ für eine spezielle Fähigkeit und „Daumen runter“ für einen normalen Dorfbewohner. Je mehr spezielle Charaktere im Spiel sind, desto mächtiger ist diese Seherin. Stellen Sie sicher, dass wenigstens ein „böser“ spezieller Charakter am Spiel teilnimmt, so dass die Aura-Seherin nicht nur Dorfbewohner aufspürt."},
        {selected: false, name: "Aussätzige", description: "Wenn die Werwölfe die Aussätzige töten, dürfen sie in der folgenden Nacht kein neues Opfer wählen, da sie vorübergehend selbst krank werden. Wenn das Spiel ohne Bekanntgabe der verstorbenen Charaktere gespielt wird, wählen die Werwölfe auch in der nächsten Nacht ein Opfer, das aber nicht stirbt. Wenn der Charakter aufgedeckt wird, wählen die Werwölfe kein Opfer aus."},
        {selected: false, name: "Beschwörerin", description: "Jede Nacht darf die Beschwörerin einen Spieler auswählen, der am kommenden Tag schweigen muss. Die Beschwörerin kann sich selber auswählen. Der Schweigende bleibt in der Runde sitzen und kann auch als Opfer ausgewählt werden, wobei er dann natürlich keine Verteidigungsrede halten darf."},
        {selected: false, name: "Geist", description: "Der Geist stirbt in der ersten Nacht. In jeder Nacht (inklusive der ersten) darf er einen Buchstaben auf ein Blatt Papier schreiben, den er als Nachricht aus dem Jenseits allen Spielern hinterlässt. Als Einschränkung darf er aber nicht versuchen, Spieler zu identifizieren, indem er deren Namen schreibt oder Initialen verwendet. Der Geist darf das Spiel nur von außerhalb des Kreises beobachten und andere Spieler weder ansprechen, noch mit ihnen Augenkontakt aufnehmen, noch in irgendeiner anderen Weise während des Tages mit dem Dorf in Verbindung treten. Dieser Charakter kann sehr viel Spaß machen, da das Dorf die Hinweise sehr unterschiedlich deuten kann und schon der erste Tag wesentlich engagierter mit Diskussionen als normal verbracht wird."},
        {selected: false, name: "Harter Bursche", description: "Wenn der Harte Bursche von den Werwölfen ausgewählt wird, stirbt er erst in der folgenden Nacht und nicht bereits in derselben."},
        {selected: false, name: "Leibwächter", description: "Der Leibwächter wählt jede Nacht einen Mitspieler, den er beschützt (aber niemals zweimal hintereinander denselben Spieler). Dieser Spieler kann nachts nicht getötet werden."},
        {selected: false, name: "Lykanthrophin", description: "Die Lykanthrophin besitzt ein unterdrücktes Werwolf-Gen und sieht für die Seherin wie ein Werwolf aus, auch wenn sie dies natürlich nicht ist."},
        {selected: false, name: "Unruhestifterin", description: "Einmal während des Spiels darf die Unruhestiftzerin in der Nacht dem Moderator anzeigen, dass es am nächsten Tag zwei Hinrichtungen geben wird. Jede Nacht sollte der Moderator die Unruhestifterin aufrufen."},
        {selected: false, name: "Wolfsjunges", description: "Das Wolfsjunge gehört zu den Werwölfen und wacht in der Nacht zusammen mit diesen auf. Wenn das Wolfsjunge getötet wird, dürfen die Werwölfe in der kommenden Nacht zwei Opfer auswählen. Die Werwölfe dürfen sich zusammen mit dem Wolfsjungen darauf einigen, das Wolfsjunge zu opfern (alle Werwölfe und das Wolfsjunge müssen zustimmen). Als Ausgleich für dieses Opfer dürfen die Werwölfe in der gleichen Nacht sofort nach der Opferung des Wolfsjungen noch zwei weitere Dorfbewohner auswählen, die ebenfalls sterben."},
        {selected: false, name: "Zaubermeisterin", description: "Die Zaubermeisterin sucht jede Nacht die Seherin (der Moderator zeigt ihr „Daumen hoch“, wenn sie auf die Seherin zeigt). Die Werwölfe wissen nicht, wer die Zaubermeisterin ist, und auch die Zaubermeisterin weiß nichts über die Werwölfe. Die Seherin sieht die Zaubermeisterin als Dorfbewohner."},
        {selected: false, name: "Verfluchter", description: "Der Verfluchte beginnt das Spiel zuerst auf der Seite der Dorfbewohner (und wird von der Seherin vorerst als Dorfbewohner gesehen). Wenn der Verfluchte von den Werwölfen angegriffen wird, stirbt er nicht, sondern wird in der kommenden Nacht ebenfalls ein Werwolf (und wird von nun an von der Seherin als Werwolf gesehen). Der Moderator ruft in jeder Nacht den Verfluchten gesondert auf (auch nachdem er ein Werwolf geworden ist, so dass die anderen Spieler im Unklaren darüber bleiben, ob und wer bereits gewählt wurde) und zeigt ihm den „Daumen hoch“, wenn er noch Dorfbewohner ist. Sobald der Verfluchte ein Werwolf ist, öffnet er zusammen mit den anderen Werwölfen in der Nacht die Augen."},
        {selected: false, name: "Gerber", description: "Der Gerber gewinnt nur, wenn er bis zum Spielende umgebracht wird. Die Siegbedingungen für die anderen Gruppen bestehen weiterhin."}
        ]
